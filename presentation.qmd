...
Research Question 1: **Is the quality of exclusive shows in the four platforms different from non-exclusive shows?**
...
:::
:::
Result: p-value = 0.01, we reject the null hypothesis.
:::
...
**Results: **
*Point Estimates:* Intercept (52.75), Exclusive: Disney+ (-4.60), Hulu (-1.56), Prime Video (-17.86)
*P-Values:* Intercept (0.001), Exclusive: Disney+ (0.001), Hulu (0.02), Prime Video (0.001)
:::
:::
...
1.  To sum it up, the data provides sufficient evidence that exclusive shows on Hulu, Netflix, and Disney Plus tend to have higher Rotten Tomatoes ratings than non-exclusive shows on those platforms, with the exception of Prime Video.
