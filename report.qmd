...
tv_shows_cleaned |> 
  mutate(exclusive_netflix = Netflix == "Yes" & Hulu == "No" & `Prime Video` == "No" & `Disney Plus` == "No",
         exclusive_hulu = Hulu == "Yes" & Netflix == "No" & `Prime Video` == "No" & `Disney Plus` == "No",
         exclusive_prime_video = `Prime Video` == "Yes" & Netflix == "No" & Hulu == "No" & `Disney Plus` == "No",
         exclusive_disney_plus = `Disney Plus` == "Yes" & Netflix == "No" & Hulu == "No" & `Prime Video` == "No")
